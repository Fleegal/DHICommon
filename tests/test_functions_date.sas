 /*----------------------------------------------------------------------------
test_functions_date.sas

Description
    Tests for routines created by functions_date.sas. If any test fails, then
...
Input
    OPTIONS CMPLIB = Work.Functions
        ...
        search path. Specifically, the package Work.Functions.Date must be in
        the data set.
